...
public class GenreDocumentControllerTest {
    ...
    @Test
    @Transactional
    void testSaveGenreDocument_champsPersistent() {
    ...
    @Test
    @Transactional
    void testUpdateGenreDocument_nomMisAJour() {
        GenreDocument saved = restTemplate.postForEntity(
    ...
    @Test
    @Transactional
    void testDeleteGenreDocumentById_retourne404Apres() {
        GenreDocument saved = restTemplate.postForEntity(
